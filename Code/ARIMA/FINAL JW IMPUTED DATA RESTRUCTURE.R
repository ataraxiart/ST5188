# RESTRUCTURE The final dataset
library(dplyr)
library(tidyr)

imputed_df <- read.csv("../../Data/Final/final_dataset.csv")
...
write.csv(final_df, "../../Data/Final/JURONG WEST_FINAL_IMPUTED_DATASET.csv", row.names = FALSE)
