...
source(here("Code/Bayesian GP/Initial Experiments/lag_experiment.R"))
source(here("Code/Bayesian GP/Initial Experiments/covariance_experiment.R"))
source(here("Code/Bayesian GP/Initial Experiments/spatial_decay_grid_search_changi_experiment.R"))
source(here("Code/Bayesian GP/Initial Experiments/spatial_decay_bayesian_mcmc_changi_experiment.R"))
