...
#########################
#########################
#Sourcing the RScripts for the GP Experiment: Initial Stage of Experimentation

source(here("Code/spTimer/GP Experiment Files/Initial Experiments/lag_experiment.R"))
source(here("Code/spTimer/GP Experiment Files/Initial Experiments/covariance_experiment.R"))
source(here("Code/spTimer/GP Experiment Files/Initial Experiments/spatial_decay_grid_search_changi_experiment.R"))
source(here("Code/spTimer/GP Experiment Files/Initial Experiments/spatial_decay_bayesian_mcmc_changi_experiment.R"))
