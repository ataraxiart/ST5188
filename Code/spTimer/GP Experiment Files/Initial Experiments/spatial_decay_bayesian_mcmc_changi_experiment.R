...
set.seed(5188)
random_sample <- sample(1:len_data_lst,n_samples<-10)
...
iteration_list <- list()
train_df <- traindata_lst_sample[[1]]
...
post.gp <- spT.Gibbs(formula = new_formula, 
                     ...
                     cov.fnc = "spherical", nItr =5000,
                     spatial.decay = priors[[1]])
summary(post.gp)    
set.seed(5188)
...
write.csv(output_df, "hyperparameter_changi_experiment.csv")
